          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-2 bg-gray-600 hover:bg-gray-700 disabled:bg-gray-400 text-white rounded-lg transition-colors duration-200"
                title="Check if video generation is complete"
              >
                {isRefreshing ? (
                  <Loader2 className="w-4 h-4 animate-spin" />
                ) : (
            ...
            <div className="text-xs text-center">
              {videoData.status === "generating" ? (
                ...
                <span className="text-orange-600">
                  ⚠️ Images ready, waiting for audio/captions...
                </span>
              ) : videoData.status === "ready" ? (
