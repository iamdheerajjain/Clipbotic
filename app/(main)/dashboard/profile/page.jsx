...
import { useGetUserByEmail, useGetUserVideos } from "@/hooks/use-supabase";
...
export default function ProfileSettings() {
  ...
  const userData = useGetUserByEmail(user?.email);
  const userVideos = useGetUserVideos(userData?.id);

  // Loading states
  const isLoading = !userVideos || !userData;
